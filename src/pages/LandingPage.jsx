...
export default function LandingPage() {
  ...
  return (
    <div className="h-screen w-full relative overflow-hidden bg-transparent font-sans selection:bg-yellow-300 flex items-center justify-center">
      ...
      {/* Tombol Suara ON/OFF (Desktop - Pill with slider) */}
      <div className="absolute top-4 right-4 z-[100] hidden md:flex items-center">
        <AudioToggleButton variant="pill" showSlider={true} />
      </div>

      {/* Tombol Suara ON/OFF (Mobile - Round Icon with ON/OFF badge) */}
      <div className="absolute top-4 right-[72px] z-[100] flex md:hidden items-center">
